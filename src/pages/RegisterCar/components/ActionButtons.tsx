    ...
    <div className="flex flex-col items-center gap-12 w-full max-w-3xl mx-auto px-4">
      ...
      <div className="flex flex-col sm:flex-row gap-6 w-full">
        ...
        <button
          ...
          className="flex items-center justify-center space-between gap-8 w-full p-10 bg-primary text-background rounded-lg  transform transition-all duration-300 hover:scale-105"
        >
